CREATE DATABASE IF NOT EXISTS `aprumeddb`
...
for Win64 (x86_64) - - - - Host: localhost Database: aprumeddb - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - Server version 8.0.17
...
- - - - Table structure for table `avatar` - - DROP TABLE IF EXISTS `avatar`;
...
- - - - Dumping data for table `avatar` - - LOCK TABLES `avatar` WRITE;
...
- - Dump completed on 2019 -10 -08 11 :31 :31